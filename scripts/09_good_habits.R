...
strwrs_tble # # here "_tbl" identifies the object as a tibble
...
clean_data <- read_csv("path to my data table.csv") %>%
  ...
  select(-centre.number, -randomisation.envelope.number, 
         -trial.start.date, -if.potassium.6mmoles.dietetic.review.undertaken,
